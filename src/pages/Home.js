      ...
      <div className="container">
        <div className="row rounded-3">
            <div className="col-md-6 mt-3 py-5">
              <h3 className="display-5 fw-bold">Remember your child’s Immunization appointments 
                with Vaccitracker
              </h3>
              <p className="fs-5">Track your child’s immunization schedule with ease, get email 
                reminders before the date. 
              </p>
              <SignUpButton class="btn" text="Get started for free" type="submit"></SignUpButton>
            </div>
        ...
        <div className='row'>
          ...
          <div className="col-md-6 mt-5 py-5">
            <h3 className="display-5 fw-normal">Add your spouse to help 
              keep track of immunization schedules
            </h3>
            <p className="fw-light fs-4">Remember your child’s Immunization
              appointments with Vaccitracker 
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="container">
            <div className="row">
              <div className='col'>
                ...
                <h5 className="fw-normal">Add your spouse to help 
                  keep track of immunization schedules
                </h5>
                <p className="fw-light fs-4">Remember your child’s Immunization
                  appointments with Vaccitracker 
