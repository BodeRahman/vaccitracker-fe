        ...
        <div className="container gilroy">
            <div className="row d-flex justify-content-center align-items-center h-100">
                <div className="col-12 col-md-9 col-lg-7 col-xl-6">
                    ...
                    <select className="form-select form-select-lg custom-select" aria-label=".form-select-lg example" style={{backgroundColor: "#054689"}}>
                    ...
                    <Accordion className="my-3 accordion" id="accordionExample">
                        <Accordion.Item eventKey="0" className="my-3 custom-accordion">
                            ...
                            <Accordion.Body>
                                <div className="form-check form-check-reverse d-flex justify-content-between my-2" style={{ backgroundColor: checkbox1 ? '#E8FFE0' : 'rgba(253, 224, 204, 0.6)', padding: '12px 57px 12px 24px' }}>
                                    <label className="form-check-label" htmlFor="checkbox0">
                                        BCG (Baccille Calmette Guérin) vaccine
                                    </label>
                                    <input className="form-check-input" type="checkbox" value="" id="checkbox0" onChange={handleCheckbox1Change} />
                                </div>
                                <div className="form-check form-check-reverse d-flex justify-content-between my-2" style={{ backgroundColor: checkbox2 ? '#E8FFE0' : 'rgba(253, 224, 204, 0.6)', padding: '12px 57px 12px 24px' }}>
                                    <label className="form-check-label" htmlFor="checkbox1">
                                        OPV (Oral polio vaccine)
                                    </label>
                                    <input className="form-check-input" type="checkbox" value="" id="checkbox1" onChange={handleCheckbox2Change}/>
                                </div>
                                <div className="form-check form-check-reverse d-flex justify-content-between my-2" style={{ backgroundColor: checkbox3 ? '#E8FFE0' : 'rgba(253, 224, 204, 0.6)', padding: '12px 57px 12px 24px' }}>
                                    <label className="form-check-label" htmlFor="checkbox2">
                                        Pediatric Hepatitis B vaccine
                                    </label>
                                    <input className="form-check-input" type="checkbox" value="" id="checkbox2" onChange={handleCheckbox3Change} />
                                </div>
                            </Accordion.Body>
                        </Accordion.Item>
